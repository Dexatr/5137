...
#define P03_BIT      (0x10)
#define P04_BIT      (0x08)
#define UNUSED_BIT_6 (0x04)
#define UNUSED_BIT_7 (0x02)
#define UNUSED_BIT_8 (0x01)

// read bits left to right, MS-bit on left
#define DATA_BIT_1 (0x80)
#define DATA_BIT_2 (0x40)
#define DATA_BIT_3 (0x20)
#define DATA_BIT_4 (0x10)
#define DATA_BIT_5 (0x08)
#define DATA_BIT_6 (0x04)
#define DATA_BIT_7 (0x02)
#define DATA_BIT_8 (0x01)
